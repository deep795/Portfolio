  ...
  function toggleDarkTheme() {
    ...
    if (isDarkTheme) {
      ...
      home1bgimg.style.backgroundImage =
        "url('assets/img/bg/motion-texture.jpg')";
    } else {
      darktoggle.src = "assets/img/icon/mon-icon.png";
      home1bgimg.style.backgroundImage = "url('assets/img/bg/pexels.jpg')";
      home2bgimg.style.backgroundImage = "url('assets/img/bg/pexels.jpg')";
    }
  }
